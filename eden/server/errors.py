...
_missinginfo    = {'response':"ERROR", 'type': "notfound:info", 'msg':"There is information missing from your request."}
_playernotfound = {'response':"ERROR", 'type': "notfound:player", 'msg':"The player you are attempting to access properties of could not be found"}
_wrongpassword  = {'response':"ERROR", 'type': "permission:wrongpass", 'msg':"Incorrect password"}
_sketchyip      = {'response':"ERROR", 'type': "permission:sketchyip", 'msg':"You are not able to log on as this player as another IP address has already logged on with your username."}
_unimplemented  = {'response':"ERROR", 'type': "unimplemented:*", 'msg':"Whatever you tried to access is simply not implemented."}
